...
},
{
  ...
  "fields": {
    ...
    "tours_count": 5,
    "bio": "Филолог-журналист по образованию. За плечами более 9 лет экскурсий по Грузии и барменский опыт. Писатель. Перфекционист. И просто увлеченный человек. Родился и вырос в Тбилиси. Более 10.py поколений тут. Люблю этот райский уголок на планете и свою работу. Мама-кулинар привила любовь к вкусной еде.",
    "is_pro": True,
    "company": None
  }
},
...
for items in guides:
    if items["fields"]["tours_count"]>=5:
        print(f"{items['fields']['full_name']} | {items['fields']['tours_count']}")